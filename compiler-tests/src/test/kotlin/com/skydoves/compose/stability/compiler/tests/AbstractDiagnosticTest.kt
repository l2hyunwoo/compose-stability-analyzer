 ...
 *
 * Diagnostic tests execute only the frontend (FIR analysis) and inject
 * compiler diagnostics directly into the test file as comments.
 *
 * These tests are very fast and good for testing:
